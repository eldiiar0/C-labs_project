...
namespace LAB_13
{
    public partial class Form1 : Form
    {
        ...
        {
            if (i >= s.Length) return; // check for going beyond the index
            else
            {
                groupBox1.Text = s[i];
                radioButton1.Text = value[i, 0];
                radioButton2.Text = value[i, 1];
                radioButton3.Text = value[i, 2];
                radioButton4.Text = value[i, 3];
